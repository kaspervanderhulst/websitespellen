...
public class HangManTest {
    ...
    @Test
    public void HangMan_moet_een_HangMan_spel_maken_en_initialiseren_voor_de_gegeven_speler_met_de_gegeven_woordenlijst() throws FileNotFoundException {
    ...
    public void HangMan_moet_een_exception_gooien_als_gegeven_speler_null() throws FileNotFoundException {
        hangman = new HangMan(null, geldigeWoordenlijst);
    }

    @Test (expected = DomainException.class)
    public void HangMan_moet_een_exception_gooien_als_gegeven_woordenlijst_null() throws FileNotFoundException {
        hangman = new HangMan(geldigeSpeler, null);
    }

    @Test (expected = DomainException.class)
    public void HangMan_moet_een_exception_gooien_als_gegeven_woordenlijst_leeg() throws FileNotFoundException {
    ...
    @Test
    public void raad_moet_volgende_zichtbaar_zetten_indien_fout_geraden() throws FileNotFoundException {
        hangman = new HangMan(geldigeSpeler, woordenlijstMetEnkelWoordTest);
        char letter = 'a';
    ...
    @Test
    public void raad_mag_volgende_niet_zichtbaar_zetten_indien_juist_geraden() throws FileNotFoundException {
        hangman = new HangMan(geldigeSpeler, woordenlijstMetEnkelWoordTest);
        char letter = 'e';
        assertEquals(14, hangman.getTekening().getAantalOnzichtbaar());
    ...
    @Test
    public void raad_mag_volgende_niet_zichtbaar_zetten_en_gewonnen_op_true_als_laatste_letter_juist_geraden() throws FileNotFoundException {
    ...
    @Test
    public void raad_moet_volledige_afbeelding_zichtbaar_zetten_en_gameover_op_true_als_laatste_kans_fout_geraden() throws FileNotFoundException {
